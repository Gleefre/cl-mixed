...
(defmethod initialize-instance :after ((segment fader) &key from to time type samplerate bypass)
  (with-error-on-failure ()
    (mixed-cffi:make-segment-fade (float from 0f0) (float to 0f0) (float time 0f0) type samplerate (handle segment)))
...
(define-field-accessor fade-type fader mixed-cffi:fade-type)
